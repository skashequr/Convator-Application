  ...
  return (
    <div className="container mt-5">
      ...
      <div>
       ...
       <div className='grid grid-cols-6 gap-7 p-6 border border-cyan-950'>
       {photos.map(photo => ( <img className='h-60 ' key={photo.id} src={URL.createObjectURL(photo)} alt={photo.altText} />))}
       </div>
      </div>
