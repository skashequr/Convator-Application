...
const Users = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/user/pagginate?page=${currentPage}&pageSize=${5}`)
    ...
    const { data: allUsers, isLoading, error } = useQuery({
        ...
        queryFn: async () => {
            try {
                const response = await axios.get('http://localhost:5000/user/fetchUsers');
...
<div className="relative overflow-x-auto shadow-md sm:rounded-lg  pt-24 px-10">
